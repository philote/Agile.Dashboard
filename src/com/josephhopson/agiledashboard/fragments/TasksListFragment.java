 ...
 */
public class TasksListFragment extends SherlockListFragment 
	...
	public static TasksListFragment newInstance(String storyId, String projectId) {
		TasksListFragment mTasksListFragment = new TasksListFragment();
		
		Bundle args = new Bundle();
		args.putString(STORY_ID, storyId);
		args.putString(PROJECT_ID, projectId);
		mTasksListFragment.setArguments(args);
		
		return mTasksListFragment;
	}

 ...
 */
public class AttachmentsListFragment extends SherlockListFragment 
		implements LoaderManager.LoaderCallbacks<Cursor> {
	
	public static final String STORY_ID = "com.josephhopson.agiledashboard.fragments.AttachmentsListFragment.storyid";
	public static final String PROJECT_ID = "com.josephhopson.agiledashboard.fragments.AttachmentsListFragment.projectid";
	
	public static AttachmentsListFragment newInstance(String storyId, String projectId) {
		AttachmentsListFragment mAttachmentsListFragment = new AttachmentsListFragment();
		
		Bundle args = new Bundle();
		args.putString(STORY_ID, storyId);
		args.putString(PROJECT_ID, projectId);
		mAttachmentsListFragment.setArguments(args);
		
		return mAttachmentsListFragment;
	}

...
public class ProjectsIntentService extends IntentService {
	...
	public static final String URL 
		= "com.josephhopson.pivotal.tracker.service.projects.ProjectsIntentService.url";
	public static final String ID 
		= "com.josephhopson.pivotal.tracker.service.projects.ProjectsIntentService.id";
	...
	protected void onHandleIntent(Intent intent) {
		...
		try {
			...
			ProjectProcessor mProjectProcessor = new ProjectProcessor(this);
			mProjectProcessor.processProject(mRestClient.getResponse());
			
		} catch (Exception e) {
			Log.e(getClass().getName(), "Exception getting the project(s)", e);

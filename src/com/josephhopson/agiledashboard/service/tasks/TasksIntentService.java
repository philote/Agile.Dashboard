...
public class TasksIntentService extends IntentService {
	...
	public static final String URL 
		= "com.josephhopson.pivotal.tracker.service.tasks.TasksIntentService.url";
	public static final String ID 
		= "com.josephhopson.pivotal.tracker.service.tasks.TasksIntentService.id";
	public static final String STORY_ID 
		= "com.josephhopson.pivotal.tracker.service.tasks.TasksIntentService.storyid";
	...
	protected void onHandleIntent(Intent intent) {
		...
		try {
			...
			TaskProcessor mTaskProcessor = new TaskProcessor(this);
			mTaskProcessor.processTask(mRestClient.getResponse(), storyId);
			
		} catch (Exception e) {
			Log.e(getClass().getName(), "Exception getting the tasks", e);
